...
namespace Lombeo.Api.Authorize.Migrations
{
    ...
    [Migration("20240710165807_add-Doctor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lombeo.Api.Authorize.DTO.DoctorDTO.DoctorInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Lombeo.Api.Authorize.DTO.DoctorDTO.DoctorInfo", b =>
                {
                    b.HasOne("Lombeo.Api.Authorize.Infra.Entities.Doctor", null)
                        .WithMany("Info")
